...
export const TIPO_DOCUMENTO_OPTIONS = [
  ...
  {
    value: 'Antecedentes',
    label: 'Antecedentes penales/policiacos',
  },
...
export const MODULES = {
  ...
  empleados: {
    ...
    fields: [
      ...
      {
        name: 'nombre_cuenta',
        label: 'A nombre de quién está la cuenta',
        type: 'text',
        onlyText: true,
        maxLength: 100,
      },
  ...
  asistencias: {
    ...
    fields: [
      ...
      },
      {
        ...
        type: 'select',
        options: TIPO_HORA_EXTRA_OPTIONS,
      },
      {
        name: 'observaciones',
        label: 'Observaciones',
  ...
  'historial-empleado': {
    ...
    fields: [
      ...
      // ⭐ SOLO APARECE AL EDITAR UNA BAJA
      {
        name: 'estado',
        ...
        options: [
          ...
          {
            value: 'ACTIVO',
            label: 'Volver a activar empleado',
          },
        ],
      },
    ],
...
export const NAV_SECTIONS = [
...

  {
    ...
    entries: [
      {
        key: 'historial-empleado',
        label: 'Bajas de empleado',
        icon: 'history',
        adminOnly: true,
      },
      {
        key: 'fotos-asistencia',
        label: 'Fotos de asistencia',
        icon: 'photo_camera',
      },
    ],
  },
